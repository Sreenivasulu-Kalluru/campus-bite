...
export const metadata: Metadata = {
  title: 'Privacy Policy | Campus Bite',
  description:
    'Privacy Policy for Campus Bite. Learn how we collect, use, and protect your data.',
};
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sm:p-12">
          ...
          <div className="prose prose-indigo max-w-none text-gray-600 space-y-6">
            ...
            <section>
              ...
              <p>
                Welcome to Campus Bite. We respect your privacy and are
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 mt-2">
                ...
                <li>
                  ...
                  fees and charges; Collect and recover money owed to us.
                </li>
                <li>
